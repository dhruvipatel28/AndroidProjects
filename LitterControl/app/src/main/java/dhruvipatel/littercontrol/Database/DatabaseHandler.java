package dhruvipatel.littercontrol.Database;
...
public class DatabaseHandler extends SQLiteOpenHelper
{
    ...
    private static final String KEY_REPLAY = "hasReplay";
    ...
    public void addPost(Post post)
    {
        ...
        values.put(KEY_REPLAY, post.getComment()); // Post hasReplay
    ...
    public Post getPost(int id)
    {
        ...
        Post post = new Post(Integer.parseInt(cursor.getString(0)),
                ...
                , Boolean.parseBoolean(cursor.getString(6)) //replay
                ) ;
                //new Post();
    ...
    public List<Post> getAllPost()
    {
        ...
        if (cursor.moveToFirst())
        {
            do {
                ...
                post.setHasReplay( Boolean.parseBoolean(cursor.getString(6)));
    ...
    public int updatePost(Post post)
    {
        ...
        values.put(KEY_REPLAY, post.getHasReplay());
